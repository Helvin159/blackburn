...
?>
		...
		<div id="mobilecarousel" class="carousel slide" data-ride="carousel">
			<div class="carousel-inner">
				...
				while($showPost->have_posts()){
					$showPost->the_post(); ?>
						<div class="carousel-item <?php if($count <= 0){ echo 'active';} ?>" style="background:url(<?php the_post_thumbnail_url('iphone')?>);height:100vh;width:100vw;background-size:cover;background-repeat:no-repeat;background-position:center center">
			<!-- <img src=""  class="d-block w-100 img-fluid" alt="..."> -->
		</div>
		<?php $count++;?>
				<?php } ?>
		...
		<div id="tabletcarousel" class="carousel slide" data-ride="carousel">
			...
			<?php 
				...
				while($showPost->have_posts()){
					$showPost->the_post(); ?>
						<div class="carousel-item <?php if($count <= 0){ echo 'active';} ?>" style="background:url(<?php the_post_thumbnail_url('ipadLandscape')?>);height:100vh;width:100vw;background-size:cover;background-repeat:no-repeat;background-position:center center">
			<!-- <img src=""  class="d-block w-100 img-fluid" alt="..."> -->
		</div>
				<?php $count++; } ?>
			</div>
